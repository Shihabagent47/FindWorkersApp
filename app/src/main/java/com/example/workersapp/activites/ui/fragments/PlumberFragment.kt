...
class PlumberFragment : BaseFragment() {
    var lit:Double =0.0
    var lon:Double=0.0
    ...
    override fun onCreateView(
        ...
        val root = inflater.inflate(R.layout.fragment_plumber, container, false)
    ...
    private fun getDashboardItemsList() {
        ...
        FirestoreClass().getPlumberItemsList(this@PlumberFragment,"Plumber",lit,lon)
    }
