...
class CraftManFragment : BaseFragment() {
    var lit:Double =0.0
    var lon:Double=0.0
    ...
    override fun onCreateView(
        ...
        val root = inflater.inflate(R.layout.fragment_craft_man, container, false)
    ...
    private fun getDashboardItemsList() {
        ...
        FirestoreClass().getCraftManItemsList(this@CraftManFragment,"Craft Man",lit,lon)
    }
