...
class MasonFragment : BaseFragment() {
    var lit:Double =0.0
    var lon:Double=0.0
    ...
    override fun onCreateView(
        ...
        val root = inflater.inflate(R.layout.fragment_mason, container, false)
    ...
    private fun getDashboardItemsList() {
        ...
        FirestoreClass().getMsonItemsList(this@MasonFragment,"Mason",lit,lon)
    }
