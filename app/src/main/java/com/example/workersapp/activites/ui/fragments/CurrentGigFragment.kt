...
import com.example.workersapp.activites.ui.adapters.MyProductsListAdapter
import com.example.workersapp.firestore.FirestoreClass
import com.example.workersapp.models.Workers
import kotlinx.android.synthetic.main.fragment_current_gig.*


class CurrentGigFragment : BaseFragment() {
    ...
    override fun onCreateView(
        ...
        mRootView = inflater.inflate(R.layout.fragment_current_gig, container, false)
        return mRootView
    }
...
//    }
    ...
    private fun getProductListFromFireStore() {
        ...
        FirestoreClass().getProductsList(this@CurrentGigFragment)
    }
     ...
     */
    fun successProductsListFromFireStore(productsList: ArrayList<Workers>) {
        ...
        if (productsList.size > 0) {
            ...
            val adapterProducts =
                MyProductsListAdapter(requireActivity(), productsList, this@CurrentGigFragment)
    ...
    private fun showAlertDialogToDeleteProduct(productID: String) {
        ...
        builder.setPositiveButton(resources.getString(R.string.yes)) { dialogInterface, _ ->
            ...
            // Call the function of Firestore class.
            FirestoreClass().deleteProduct(this@CurrentGigFragment, productID)
