...
class MoversFragment : BaseFragment() {
    var lit:Double =0.0
    var lon:Double=0.0
    ...
    override fun onCreateView(
        ...
        val root = inflater.inflate(R.layout.fragment_movers, container, false)
    ...
    private fun getDashboardItemsList() {
        ...
        FirestoreClass().getMoversItemsList(this@MoversFragment,"Mover",lit,lon)
    }
